...
const Home = () => {
  return (
    <div className="flex items-center justify-center text-center flex-col w-full pt-10">
        <h1 className="text-8xl my-4 text-white">Superfast Recipe Creation<br /> <span className="text-red-400 text-6xl"> Powered by AI</span></h1>
        <p className="text-2xl text-white/60 mb-6">Create delicious recipes in seconds—no more guessing ingredients!</p>
